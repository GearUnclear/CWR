...
| 26 | Civilian solicitation and extortion (#41) | shared `civilian_interaction*.sqs` | **script** | Lazy bounded opinion/fear cache within 300 m; 5 m action menu, donation/extortion thresholds, cooldown and opinion recovery, persistent support nudges and treasury credits, load remount, #42 resistance callback. See [CIVILIAN-INTERACTIONS.md](CIVILIAN-INTERACTIONS.md). |
