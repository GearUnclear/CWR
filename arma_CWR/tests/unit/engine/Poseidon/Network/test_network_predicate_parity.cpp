...
TEST_CASE("Squad logo paths reject unsafe XML path components", "[network][squad][assets]")
{
    ...
    REQUIRE(Poseidon::NetworkSquadPictureStorageName(RString("https://example.com/squads/raw/"
                                                             "synthetic_grid.paa")) == RString("synthetic_grid.paa"));
    REQUIRE(Poseidon::BuildNetworkSquadPictureTmpPath(RString("CWR"), RString("https://example.com/squads/raw/"
                                                                              "synthetic_grid.paa")) ==
            RString("tmp/squads/CWR/synthetic_grid.paa"));
    ...
    REQUIRE(Poseidon::BuildNetworkSquadPictureTmpPath(RString("CWR"), RString("../synthetic_grid.paa")).GetLength() ==
            0);
    REQUIRE(Poseidon::BuildNetworkSquadPictureDownloadUrl(RString("https://example.com/squads/raw/squad.xml"),
                                                          RString("synthetic_grid.paa")) ==
