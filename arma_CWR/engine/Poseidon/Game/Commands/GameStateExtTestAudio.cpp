...
GameValue TriLBSize(const GameState*, GameValuePar);
GameValue TriLBText(const GameState*, GameValuePar);
GameValue TriLBValue(const GameState*, GameValuePar);
GameValue TriLBCurSel(const GameState*, GameValuePar);
GameValue TriLBTopRow(const GameState*, GameValuePar);
GameValue TriLBSetCurSel(const GameState*, GameValuePar);
...
GameValue TriMapHiddenLabels(const GameState*);
...
GameValue TriPortraitIsolation(const GameState*, GameValuePar);
GameValue TriPortraitRecreate(const GameState*);
GameValue TriPortraitCancel(const GameState*);
GameValue TriPortraitId(const GameState*, GameValuePar);
GameValue TriPortraitRow(const GameState*, GameValuePar);
GameValue TriPortraitPixels(const GameState*, GameValuePar);
...
GameValue TriAddonActive(const GameState*, GameValuePar);
...
GameValue TriMouseBtn(const GameState*, GameValuePar);
GameValue TriTapWindowMs(const GameState*, GameValuePar);
GameValue TriCamView(const GameState*);
GameValue TriCamFov(const GameState*);
...
INIT_MODULE(GameStateExtTest, 3)
{
    ...
    GGameState.NewFunction(GameFunction(GameScalar, "triLBSize", TriLBSize, GameScalar));
    GGameState.NewFunction(GameFunction(GameString, "triLBText", TriLBText, GameArray));
    GGameState.NewFunction(GameFunction(GameScalar, "triLBValue", TriLBValue, GameArray));
    GGameState.NewFunction(GameFunction(GameScalar, "triLBCurSel", TriLBCurSel, GameScalar));
    GGameState.NewFunction(GameFunction(GameScalar, "triLBTopRow", TriLBTopRow, GameScalar));
    GGameState.NewFunction(GameFunction(GameBool, "triLBSetCurSel", TriLBSetCurSel, GameArray));
    ...
    GGameState.NewFunction(GameFunction(GameBool, "triAddonActive", TriAddonActive, GameString));
    ...
    GGameState.NewFunction(GameFunction(GameString, "triMouseBtn", TriMouseBtn, GameArray));
    GGameState.NewFunction(GameFunction(GameString, "triTapWindowMs", TriTapWindowMs, GameScalar));
    GGameState.NewNularOp(GameNular(GameString, "triCamView", TriCamView));
    GGameState.NewNularOp(GameNular(GameScalar, "triCamFov", TriCamFov));
    ...
    GGameState.NewNularOp(GameNular(GameScalar, "triMapHiddenLabels", TriMapHiddenLabels));
    ...
    GGameState.NewNularOp(GameNular(GameArray, "triPortraitStats", TriPortraitStats));
    GGameState.NewNularOp(GameNular(GameBool, "triPortraitRecreate", TriPortraitRecreate));
    GGameState.NewNularOp(GameNular(GameBool, "triPortraitCancel", TriPortraitCancel));
    GGameState.NewFunction(GameFunction(GameBool, "triPortraitIsolation", TriPortraitIsolation, GameArray));
    GGameState.NewFunction(GameFunction(GameString, "triPortraitId", TriPortraitId, GameArray));
    GGameState.NewFunction(GameFunction(GameArray, "triPortraitRow", TriPortraitRow, GameScalar));
    GGameState.NewFunction(GameFunction(GameString, "triPortraitPixels", TriPortraitPixels, GameArray));
    GGameState.NewNularOp(GameNular(GameBool, "triBriefingFits", TriBriefingFits));
    GGameState.NewNularOp(GameNular(GameBool, "triPortraitRefresh", TriPortraitRefresh));
